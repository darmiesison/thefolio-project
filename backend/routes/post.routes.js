  ...
  try {
    ...
    const enrichedPosts = await Promise.all(posts.map(async (post) => {
      ...
      return {
        ...
        author_pic: author?.profile_pic && author.profile_pic.startsWith('data:') ? author.profile_pic : (author?.profile_pic ? buildImageUrl(req, author.profile_pic) : '/assets/logo-cat.png'),
